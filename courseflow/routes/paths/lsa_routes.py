...
def get_lsa_ai():
    ...
    return flask.render_template("eng.html", **ai_info)
...
def get_lsa_bio():
    ...
    return flask.render_template("eng.html", **bio_info)
...
def get_lsa_data_and_info():
    ...
    return flask.render_template("eng.html", **data_path_info)
...
def get_lsa_econ():
    ...
    return flask.render_template("eng.html", **econ_info)
...
def get_lsa_robotics():
    ...
    return flask.render_template("eng.html", **robotics_info)
...
def get_lsa_security():
    ...
    return flask.render_template("eng.html", **security_info)
...
def get_lsa_software_development():
    ...
    return flask.render_template("eng.html", **software_dev_info)
...
def get_lsa_software_systems():
    ...
    return flask.render_template("eng.html", **software_systems_info)
...
def get_lsa_theory():
    ...
    return flask.render_template("eng.html", **theory_info)
