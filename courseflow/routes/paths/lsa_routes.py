...
def get_lsa_ai():
    ...
    return flask.render_template("courses.html", **ai_info)
...
def get_lsa_bio():
    ...
    return flask.render_template("courses.html", **bio_info)
...
def get_lsa_data_and_info():
    ...
    return flask.render_template("courses.html", **data_path_info)
...
def get_lsa_econ():
    ...
    return flask.render_template("courses.html", **econ_info)
...
def get_lsa_robotics():
    ...
    return flask.render_template("courses.html", **robotics_info)
...
def get_lsa_security():
    ...
    return flask.render_template("courses.html", **security_info)
...
def get_lsa_software_development():
    ...
    return flask.render_template("courses.html", **software_dev_info)
...
def get_lsa_software_systems():
    ...
    return flask.render_template("courses.html", **software_systems_info)
