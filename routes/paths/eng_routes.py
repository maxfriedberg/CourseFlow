...
def get_eng_hardware():
    ...
    return flask.render_template("eng.html", **hardware_info)
...
def get_eng_infrastructure():
    ...
    return flask.render_template("eng.html", **infrastructure_info)
...
def get_eng_intelligent_systems():
    ...
    return flask.render_template("eng.html", **intelligent_sys_info)
...
def get_eng_software():
    ...
    return flask.render_template("eng.html", **software_info)
...
def get_eng_webtech():
    ...
    return flask.render_template("eng.html", **web_tech_info)
